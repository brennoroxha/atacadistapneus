...
function MedidasTab() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <h2 className="text-lg md:text-4xl font-black text-gray-900 tracking-tight whitespace-nowrap overflow-hidden text-ellipsis w-full">
...
function InteligenteTab() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <h2 className="text-lg md:text-4xl font-black text-gray-900 tracking-tight whitespace-nowrap">
