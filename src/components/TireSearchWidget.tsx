...
import tireMeasureImg from "@/assets/tire-measure.png";
...
export function TireSearchWidget() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-white md:rounded-2xl md:shadow-xl border-0 md:border md:border-gray-100 relative z-30">
      {/* Tabs */}
...
function MedidasTab() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <img
        src={tireMeasureImg}
        alt="Como identificar a medida do pneu"
        loading="lazy"
        width={1024}
        height={1024}
        className="mt-4 w-full max-w-md h-auto object-contain"
      />
