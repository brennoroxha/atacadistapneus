// Imports new Aro 15 products following the full standard pattern:
// - Normalized name (Pneu MEDIDA Marca Modelo Aro 15 IC+IV)
...
const CATEGORY_ID = '4b700874-4901-42a3-b07c-1a4a56ce4ebe';
const SRC = process.env.SRC || '/tmp/aro15_new.json';
